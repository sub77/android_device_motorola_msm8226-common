...
public class VibratorStrengthPreference extends SeekBarDialogPreference implements
    ...
    private static final String FILE_PATH = "/sys/devices/virtual/timed_output/vibrator/vtg_level";
    ...
    class VibrationSeekBar implements SeekBar.OnSeekBarChangeListener {
        ...
        protected void updateValue(int progress) {
            /* Since 100% is not actually MAX_VALUE anymore, convert it */
            mValueDisplay.setText(String.valueOf(progress*100/MAX_VALUE) + "%");
        }
